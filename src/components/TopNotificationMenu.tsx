      ...
      <div className="max-h-80 overflow-y-auto">
        <a href="#" className="dropdown-menu py-4 flex">
          ...
          <div className="ml-3 mr-2">
            <h3>Mathematics</h3>
            <span className="text-gray-700 dark:text-gray-400">You have a new assignment</span>
          </div>
        ...
        <a href="#" className="dropdown-menu py-4 flex">
          ...
          <div className="ml-3 mr-2">
            ...
            <span className="text-gray-700 dark:text-gray-400">Your assignment has been graded</span>
          </div>
